...
<template>
  <div class="p-5">
    <div
      class="bg-[#FEFEFE] w-full h-[53px] rounded-lg py-3 px-5 shadow-md flex justify-between items-center"
    >
      <p class="text-lg font-medium">Dashboard</p>
      <div>
        <div v-if="!dropdown" @click="dropdownToggle" class="cursor-pointer font-semibold">
          Hello, {{ user.name }}
        </div>
