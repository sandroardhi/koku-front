...
const fetchUangMasuk = async () => {
  ...
  try {
    const { data } = await dashboard_repository.uangMasukAdminPenjual()
...
const onSubmit = async () => {
  ...
  formdata.append('kantin_id', selectedItem.value.kantin_id)
  selectedItem.value.orderbarang_id.forEach((id) => {
    formdata.append('orderbarang_id[]', id)
  })
        ...
        <template #customButton="{ item }">
          ...
          >
            <template #modalBody>
              ...
              >
                <div class="grid gap-4 mb-4 grid-cols-2">
                  <p class="text-lg font-medium">Data Penjual:</p>
                  <div class="col-span-2">
                    <p class="text-md text-gray-90 font-medium">Nama:</p>
                    <!-- <p>{{ item.orders[0].kantin.penjual.name }}</p> -->
                  </div>
                  <div class="col-span-2">
                  ...
                  <div class="col-span-2">
                    ...
                    <p>{{ formatter.format(selectedItem.harga) }}</p>
                  </div>
                  <div class="col-span-2">
                    <label
                      for="nama"
