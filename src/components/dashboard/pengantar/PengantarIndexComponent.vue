...
const addTotalHarga = (orders) => {
  ...
  orders.forEach((order) => {
    totalHarga += order.orders[0].ongkir
  })
...
<template>
  <div class="w-full relative">
    <div class="w-full h-[150px] grid grid-cols-3 gap-4">
      ...
      <div class="col-span-1 bg-white rounded-lg shadow-lg relative p-5 overflow-hidden">
        <svg
          ...
          xml:space="preserve"
          fill="#000000"
          class="w-32 h-32 absolute top-2 -right-3"
        >
          <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
          <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
          <g id="SVGRepo_iconCarrier">
    ...
    <div
      class="w-full h-16 rounded-lg shadow-md bg-white flex justify-between px-5 items-center my-7"
    >
      ...
      <form :action="route.path" class="flex flex-col" v-if="user.pengantarIsAvailable == 'active'">
              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-6 py-4">
                      <p v-if="order.orders[0].status_ongkir == 'Sukses'" class="font-semibold">
                        Sedang diproses oleh admin
                      </p>
                      <div v-else-if="order.orders[0].status_ongkir == 'Selesai'">
                        <div class="w-full flex" v-if="order.orders[0].tipe_pembayaran == 'Online'">
            ...
            <table class="w-full text-md text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-6 py-4">
                    <p v-if="order.orders[0].status_ongkir == 'Sukses'">
                      Sedang diproses oleh admin
                    </p>
                    <div
                      v-else-if="order.orders[0].status_ongkir == 'Selesai'"
                      class="font-semibold"
                    >
                      <div class="w-full flex" v-if="order.orders[0].tipe_pembayaran == 'Online'">
                        <p class="text-green-600 font-semibold">
